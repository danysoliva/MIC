...
namespace MIC.Clases
{
    public class CajaDialogo
    {
        ...
        public static DialogResult InformationDownload()
        {
            return MessageBox.Show("Archivo descargado con exito!", "Confirmación", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
    }
}
